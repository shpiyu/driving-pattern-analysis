...
public class LockingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //lockUnlockButton = (Button) findViewById(R.id.lock_unlock_button);
    ...
    private void turnOffLed()
    {
        if (btSocket!=null)
        {
            ...
            {
                msg("Error");
                Log.d("debug","error trying");
            }
        }
        else{
            Log.d("debug", "bt socket is null");
        }
    }
    ...
    private class ConnectBT extends AsyncTask<Void, Void, Void>  // UI thread
    {
        ...
        {
            progress = ProgressDialog.show(LockingActivity.this, "Connecting...", "Please wait!!!");  //show a progress dialog
        }
